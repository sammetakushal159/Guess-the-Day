...
public class runinfinity extends AppCompatActivity {
    private static final String TAG = "RunInfinity";

    public static final String INFI_SAVED = "infi_sharedPreferences";
    public static final String INFI_SCORE = "infi_score";
    ...
    Button Button1, Button2, Button3, Button4,end;
    int currentScore = 0, best = 0, noofques;
    int d1 = 0, d2 = 0, m1 = 0, m2 = 0, y1 = 0, y2 = 0, y3 = 0, y4 = 0, rem = 0, ans = 0;
    int opt1 = 0, opt2 = 0, opt3 = 0, opt4 = 0,infi_savedscore;

    @SuppressLint("SetTextI18n")
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_runinfinity);
        Log.d(TAG, "onCreate: Started");

        vibrator = (Vibrator)getSystemService(VIBRATOR_SERVICE);

        question = findViewById(R.id.infi_ques);
        Best = findViewById(R.id.infi_best);
        Noofques = findViewById(R.id.infi_noofques);
        score = findViewById(R.id.infi_score);
        end = findViewById(R.id.end_infi);
        Button1 = findViewById(R.id.infi_btn1);
        Button2 = findViewById(R.id.infi_btn2);
        Button3 = findViewById(R.id.infi_btn3);
        Button4 = findViewById(R.id.infi_btn4);
        screenColour = findViewById(R.id.colour_infi);

        retrieveData();
        Best.setText("best score :"+infi_savedscore);
        best = infi_savedscore;
        getValues();
        ...
        Button4.setOnClickListener(new View.OnClickListener() {
            ...
            @Override
            public void onClick(View v) {
                Log.d(TAG, "onClick: CLicked button end");
                gotoInfinity();
            }
        });
    }
    ...
    public void saveData() {
        SharedPreferences sharedPreferences = getSharedPreferences(INFI_SAVED, MODE_PRIVATE);
        SharedPreferences.Editor editor = sharedPreferences.edit();
        editor.putInt(INFI_SCORE, best);
        editor.apply();
    }

    public void retrieveData() {
        SharedPreferences sharedPreferences = getSharedPreferences(INFI_SAVED, MODE_PRIVATE);
        infi_savedscore = sharedPreferences.getInt(INFI_SCORE, 0);
    }
    ...
    public void gotoInfinity()
    {
        ...
        saveData();
        Intent intent_runinfinity_infinity = new Intent(this, infinity.class);
        startActivity(intent_runinfinity_infinity );
    }
}